...
We choose to upload the head of the dataset from RStudio only after performing data cleaning, as the original datasets are highly unstructured and not easily readable in their raw state.
...
## 2.2.2 Provide a short summary of the dataset(s)
