...
Regarding mental health, our results show that most gemeentes reported better than the national average mental health. Each year, from 2020 to 2023, around 76 to 80% of gemeentes were below the national average, and around 20 to 25% were above. That indicates that mental health issues are more concentrated in only a small portion of the total gemeentes. The percentage of gemeentes above the national average is decreasing while the percentage below is increasing. Although it suggests that fewer areas are struggling, those that are might be struggling more intensely.
